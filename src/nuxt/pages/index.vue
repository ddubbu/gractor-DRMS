    ...
    <div id="modify-modal-wrapper">
      <div id="modify-modal">
        ...
        <div>
          ...
          <input
            name="name"
            :value="input_modal.name"
            @input="inputHandler($event, 'input_modal')"
          />
        </div>
        <div>
          <label>내용</label>
      ...
      <section id="input-form">
        <div>
          ...
          <input
            name="name"
            :value="input.name"
            @input="inputHandler($event, 'input')"
          />
        </div>
        <div>
          <label>내용</label>
...
export default {
  ...
  methods: {
    ...
    async submitHandler() {
      ...
      this.$axios.$post('/api/users', this.input).then((data) => {
        // chat 추가
        this.chats.push({
          id: data.id,
    ...
    deleteHandler(e, id) {
      this.$axios.$delete('api/users', { params: { id } }).then((res) => {
        // chats 갱신
        this.getChats();
